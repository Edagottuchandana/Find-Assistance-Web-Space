    ...
    <div class="form-group">
      <div class="row">
        <div class="col-md-6">
          ...
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox1" value=" Plumbing Services" style="border: 1px solid #ccc;" />
        </div>
        <div class="col-md-6">
         
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox2" value=" Instalation/replacement service " style="border: 1px solid #ccc;" />
        </div>
      </div>
      <div class="row mt-3">
        <div class="col-md-6">
         
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox3" value=" Plumbing Contractors" style="border: 1px solid #ccc;" />
        </div>
        <div class="col-md-6">
          
          <input type="text" readonly class="form-control-plaintext" id="staticTextBox4" value="Purchase PLumbing Products" style="border: 1px solid #ccc;" />
        </div>
      </div>
    </div>
    <p class="card-text"></p>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image6.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">New Bismilliah Enterprises</h5>
        <p class="card-text">Rating: 5.5/5</p>
        <p class="card-text card-text-location">Location:Pavani Circle Galiveedu,kadapa</p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Bismilliah@gmail.com</p>
        <p>Phone: +6732487657</p>
      </div>
    </div>
  </div>
</div> 
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image7.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Claim Ac Repair And Services</h5>
        <p class="card-text">Rating: 7.5/5</p>
        <p class="card-text card-text-location">Location: Kadapa City,kadapa</p>
...
<div class="modal fade" id="contactModal2" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel2" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Claim@gmail.com</p>
        <p>Phone: +7342973495</p>
      </div>
    </div>
  </div>
</div>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image8.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Ajantha Agencies</h5>
        <p class="card-text">Rating: 5.5/5</p>
        <p class="card-text card-text-location">Location:Rayachoti Ho,Rayachoti</p>
...
<div class="modal fade" id="contactModal3" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Ajantha@gmail.com</p>
        <p>Phone: +7613208417</p>
      </div>
    </div>
  </div>
</div>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image9.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Prasad Electrical Works</h5>
        <p class="card-text">Rating: 8.5/5</p>
        <p class="card-text card-text-location">Location:Ananthapur,Ananthapru</p>
...
<div class="card horizontal-card">
  <div class="row no-gutters">
    <div class="col-md-3">
      <img src="image10.png" class="card-img rounded-circle" alt="Profile Picture">
    </div>
    <div class="col-md-9">
      <div class="card-body">
        <h5 class="card-title">Shankar Plumber Services</h5>
        <p class="card-text">Rating: 7.5/5</p>
        <p class="card-text card-text-location">Location:Ananthapuram,Alamuru,Ananthapuram</p>
...
<div class="modal fade" id="contactModal5" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel5" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Email: Shanker@gmail.com</p>
        <p>Phone: +7649839485</p>
      </div>
    </div>
  </div>
</div>
<?php
   $con=mysqli_connect("localhost","root","","data");
    $result = mysqli_query($con, "SELECT * FROM plumber");
